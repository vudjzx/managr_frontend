...
const SearchModal = () => {
  ...
  const {searchModal, handleSearchModal, projects} = useProjects();
        ...
        <Transition.Child
          ...
          <Combobox
            ...
            <div className="relative">
              <Combobox.Input
                className="h-12 w-full border-0 bg-transparent pl-4 pr-4 text-gray-800 placeholder-gray-400 focus:ring-0 sm:text-sm rounded-xl"
                placeholder="Search..."
